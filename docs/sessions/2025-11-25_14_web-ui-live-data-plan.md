...
## Tasks
- Completed: Add a backend adapter (HTTP or local API) that proxies to existing CLI/service handlers.
- Completed: Replace mock API calls in the web app with real fetch calls to the adapter; keep dry-run default for actions.
- Completed: Add minimal error/loading states to all pages.
- Completed: Update docs/changelog/session log.
