...
>
> Requirement IDs follow `docs/Requirements_ID_Scheme.md` (e.g., `W0.4_base_email_editing`,
> `W1.2_icp_discovery`, `W2.1_sim_persona_loop`) and are referenced from the roadmap and appendix.
