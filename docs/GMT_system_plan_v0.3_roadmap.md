...
an execution-oriented roadmap going forward. Requirement IDs referenced here
follow `docs/Requirements_ID_Scheme.md` (e.g., `W0.x` for Workflow 0, `W1.x` for
ICP discovery, `INT.x` for integrations).
